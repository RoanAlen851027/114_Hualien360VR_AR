...
namespace ARWT.Core{
    public class CameraController : MonoBehaviour{
        ...
        public void Update(){
            ...
            /*
            Debug.Log($"Camera Filed Of View : {cam.fieldOfView}");
            ...
            Debug.Log($"Camera Scale : {cam.transform.localScale}");
            */
        }
        ...
        public void setRotation(string val){
            ...
            transform.rotation = Quaternion.Euler(0f, 180f, 0f) * new Quaternion(x, y, z,w);
        }
        ...
        public void setEuler(string val){
            ...
            transform.eulerAngles = new Vector3(x, y + 180f, z);
        }
